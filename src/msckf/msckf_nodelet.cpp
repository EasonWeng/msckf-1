...
void MsckfNodelet::imuCallback(const sensor_msgs::Imu::ConstPtr &msg) {
    ...
    const auto rot_vel = -msckf::Vector3d{msg->angular_velocity.x, msg->angular_velocity.y, msg->angular_velocity.z};
    const auto vel = msckf::Vector3d{msg->linear_acceleration.x, msg->linear_acceleration.y, msg->linear_acceleration.z};
