...
PLUGINLIB_EXPORT_CLASS(feature_tracker::FeatureTrackingNodelet,nodelet::Nodelet)
...
void FeatureTrackingNodelet::onInit() {
    ...
    image_sub = image_transport.subscribe("/cam0/image_raw", 3,
                                          &FeatureTrackingNodelet::imageCallback, this);
    camera_info_sub = nh.subscribe("/cam0/camera_info", 1,
